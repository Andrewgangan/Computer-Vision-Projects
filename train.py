...
NN_ARCHITECTURE = [
    {"input_dim": 784, "output_dim": 256, "activator": "tanh"},
    {"input_dim": 256, "output_dim": 10, "activator": "tanh"}
]
...
if __name__ == "__main__":
    ...
    f1 = plt.figure(1)
    x = np.arange(1, MAX_ITER + 1, 1)
    y = np.asarray(train_loss)
    z = np.asarray(test_loss)
